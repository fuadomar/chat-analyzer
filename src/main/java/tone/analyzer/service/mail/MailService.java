...
public class MailService {
    ...
    public void sendMail(NewUserInvitationNotification userInvitationNotification) {
        ...
        EmailInvitation emailInvitation = new EmailInvitation(userInvitationNotification.getSender(),
                userInvitationNotification.getReceiver(), userInvitationNotification.getToken());
